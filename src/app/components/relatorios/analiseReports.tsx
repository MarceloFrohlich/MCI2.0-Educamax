...
const AnaliseReports: React.FC<ICupFilter> = ({ copas }) => {
            ...
            <div className="flex flex-col gap-4">
                ...
                {reports.length === 0 && (
                    <span className="text-sm text-[#969696] font-medium">
                        Selecione uma copa para visualizar a análise.
                    </span>
                )}
                    ...
                    >
                        ...
                        <div className="flex flex-wrap items-center justify-between gap-2">
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <AvaliacaoModal report={report} onSaved={fetchReports} />

                                {report.status?.status === 'success' && (
                                    <FaThumbsUp className="size-5 text-[#2FA84F]" />
                                )}

                                {report.status?.status === 'unsuccess' && (
                                    <FaThumbsDown className="size-5 text-[#C94F4F]" />
                                )}
